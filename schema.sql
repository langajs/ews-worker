...
CREATE UNIQUE INDEX IF NOT EXISTS idx_shopee_stores_user_context ON ews_shopee_stores(user_id, template_context_id);
CREATE INDEX IF NOT EXISTS idx_shopee_stores_user_active ON ews_shopee_stores(user_id, is_active);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_shopee_templates_store_hash ON ews_shopee_store_templates(store_id, sha256);
CREATE INDEX IF NOT EXISTS idx_shopee_templates_store_active ON ews_shopee_store_templates(store_id, is_active);
